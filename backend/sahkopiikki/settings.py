"""
Django settings for sahkopiikki project.
...
import os
from secrets import SLACK_WEBHOOK_URL, SECRET_KEY
...
WSGI_APPLICATION = 'sahkopiikki.wsgi.application'
